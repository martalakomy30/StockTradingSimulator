...
public class PriceFactory {
    ...
    //cents passed in, price object created
    private static HashMap <Integer, Price> prices;
    public static Price makePrice(int value){
        if(prices == null) prices = new HashMap<Integer, Price>();
        if(!(prices.containsKey(value)))prices.put(value, new Price(value));
